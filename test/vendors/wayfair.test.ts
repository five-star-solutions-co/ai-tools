...
describe('wayfair', () => {
	test('module contracts and tool ids', () => {
		...
		expect(wayfairModule.tools.map((tool) => tool.id).sort()).toEqual([
			...
			'wayfair-list-fulfillment-orders',
			'wayfair-list-fulfillment-shipping-advices',
			'wayfair-list-inbound-orders',
			'wayfair-list-inventory-adjustments',
			'wayfair-list-inventory-summary',
			...
			'wayfair-update-advertising-campaign',

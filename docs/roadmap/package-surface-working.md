...
| `vendors/sps-commerce` | Source-ready, 2026-09-10 | 25 tools and 34 client methods covering Transaction v5, Shipping Label v1, public Packing Slip v1 and Community Submission v1. Host-bound auth, bounded artifacts and isolated batch-document downloads. Internal slip batches/private document schemas excluded. Both integrations pass the 828-test package gate, build and typecheck; work remains uncommitted. |

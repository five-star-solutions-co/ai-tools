...
| `vendors/wayfair` | Source-ready, 2026-09-10 | 40 tools: catalog/reference/update, dropship/CastleGate fulfillment, cancellations, inventory, shipping documents, inbound milestones and advertising. Production defaults preserved; sandbox supported. Public product-addition and group-media conflicts remain excluded. See [coverage](../reference/wayfair-and-sps-commerce-apis.md); no live certification or package release claimed. |
